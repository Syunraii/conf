...
0️⃣ 
1. 使用Surge模块:
https://raw.githubusercontent.com/ventusoon/ventus/main/module/github-private-repo.sgmodule
2. 使用Loon插件:
...
let config = {
    username: "Syunraii", // 用户名
    token: "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", // token
  };
